...
export default function LoginPage() {
  ...
  useEffect(() => {
    ...
    const pid = typeof window !== 'undefined' ? localStorage.getItem('participant_id') : null
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 12, marginBottom: 20 }}>
          ...
          <div style={{ display: 'flex', gap: 10, marginTop: 4 }}>
            <button
              ...
              style={{
                ...
                boxShadow: '0 4px 14px rgba(0,114,255,0.35)', opacity: loading ? 0.7 : 1,
              }}
          ...
          <div style={{ textAlign: 'center', fontSize: 13, color: '#C9D4E5', marginTop: 4 }}>
            Нет аккаунта?{' '}
            <a href="/register" style={{ color: '#00C6FF', fontWeight: 600, textDecoration: 'none' }}
